...
All calculations can be reproduced via the CLI:
```bash
python run.py analyze risk --platform polymarket
```

## Outputs

- `output/charts/favorite_longshot_risk.png` - Risk analysis charts
